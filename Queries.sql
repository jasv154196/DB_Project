...
SELECT * FROM DB_Project.TerroristAttacksByYearByNo ORDER BY No_Attacks DESC;
...
#Delete Table
DELETE FROM DB_Project.Terrorism WHERE Event_ID = 20182018;
DELETE FROM DB_Project.Dates WHERE DATE_ID = 18181818;
